...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_artifact",
        type=str,
        help="Name of the input artifact (raw dataset) from W&B",
        required=True
    )
    ...
    parser.add_argument(
        "--output_artifact",
        type=str,
        help="Name of the output artifact (cleaned dataset) to create in W&B",
        required=True
    )
    ...
    parser.add_argument(
        "--min_price",
        type=float,
        help="Minimum Airbnb price filter",
        required=True
    )
    ...
    parser.add_argument(
        "--max_price",
        type=float,
        help="Maximum Airbnb price filter",
        required=True
    )
